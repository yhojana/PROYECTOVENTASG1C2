...
public class MainProducto extends javax.swing.JPanel {
    ...
    private void ListarProductos() {
        ...
        for (int i = 0; i < listarPruductos.size(); i++) {
            ob[0] = i + 1;
            ob[1] = listarPruductos.get(i).getNombre();
            ob[2] = listarPruductos.get(i).getPu();
            ob[3] = listarPruductos.get(i).getUtilidad();
            ob[4] = listarPruductos.get(i).getStock();
            ob[5] = listarPruductos.get(i).getIdCategoria();
            ob[6] = listarPruductos.get(i).getIdMarca();
            model.addRow(ob);
        }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        System.err.println("------");
        System.err.println(((CategoriaTO)cbxId_categoria.getSelectedItem()).getIdCategoria());
        xDao = new ProductoDao();
            ...
            try {
                ...
                if (msg.showConfirmCustom("Esta seguro de crear un nuevo cliente ?", "Mensaje de Confirmación", "") == 0) {
                    if (xDao.create(to) != 0) {
                        ...
                        Object nuevo[] = {model.getRowCount() + 1, to.getNombre(), to.getPu(), to.getUtilidad(), to.getStock()};
                        model.addRow(nuevo);
                        resetForm();
